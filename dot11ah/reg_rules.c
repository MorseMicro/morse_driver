...
struct morse_reg_rule cl_reg_rules[] = {
	/* S1G Actual Frequencies */
	_MRR_KHZ(915500, 923500, 8000, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR_KHZ(917500, 925500, 8000, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR_KHZ(919500, 927500, 8000, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),

	/* S1G->11ac Mapped Frequencies */
	_MRR(5170, 5330, 160, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(5735, 5895, 160, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(5490, 5650, 160, 0, 29, AUTO_BW, 10000, 10000, false, 0, 0, 0),
};

/* CL uses own reg rules and AU REVmf channelization */
static struct morse_regdomain mors_cl_regdom = {
	.n_reg_rules = ARRAY_SIZE(cl_reg_rules),
	.alpha2 = CHANNEL_ALPHA_CL,
	.reg_rules = cl_reg_rules,
	.channelization_scheme = CHANNELIZATION_SCHEME_IEEE80211_REVMF
};
...
struct morse_reg_rule sg_reg_rules[] = {
	/* S1G Actual Frequencies */
	_MRR(917, 925, 8, 0, 22, AUTO_BW, 10000, 10000, false, 0, 0, 0),

	/* S1G->11ac Mapped Frequencies */
	_MRR(5490, 5650, 160, 0, 22, AUTO_BW, 10000, 10000, false, 0, 0, 0),
};
...
/* MX uses US channelization */
static struct morse_regdomain mors_mx_regdom = {
	.n_reg_rules = ARRAY_SIZE(us_reg_rules),
	.alpha2 = CHANNEL_ALPHA_MX,
	.reg_rules = us_reg_rules,
	.channelization_scheme = CHANNELIZATION_SCHEME_NONE
};

/* AR uses AU REVmf channelization */
static struct morse_regdomain mors_ar_regdom = {
	.n_reg_rules = ARRAY_SIZE(au_reg_rules),
	.alpha2 = CHANNEL_ALPHA_AR,
	.reg_rules = au_reg_rules,
	.channelization_scheme = CHANNELIZATION_SCHEME_IEEE80211_REVMF
};

/* CO uses AU REVmf channelization */
static struct morse_regdomain mors_co_regdom = {
	.n_reg_rules = ARRAY_SIZE(au_reg_rules),
	.alpha2 = CHANNEL_ALPHA_CO,
	.reg_rules = au_reg_rules,
	.channelization_scheme = CHANNELIZATION_SCHEME_IEEE80211_REVMF
};
